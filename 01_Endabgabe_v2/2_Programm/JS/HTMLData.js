        ...
        <div class="contentMiddle">
            <aside class="end-bg tools">
              <section class="toolsBox">
                ...
                <button class="end-bg borderInset toolsStyle" id="sprayerButt"><img src="https://github.com/ivenios/EIA2/blob/master/01_Endabgabe_v2/3_IMG/pencil.png?raw=true" width="20px" alt=""></button>
                <button class="end-bg borderInset toolsStyle" id="resizerButt"><img src="https://github.com/ivenios/EIA2/blob/master/01_Endabgabe_v2/3_IMG/misc1.png?raw=true" width="20px" alt=""></button>
