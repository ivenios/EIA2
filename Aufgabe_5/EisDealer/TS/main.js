var EisDealerFreude22;
(function (EisDealerFreude22) {
    /*
    ...
    function renderFieldsets() {
        ...
        for (let group in EisDealerFreude22.iceDealerData) {
            if (group == "Eissorten") { //mit forschleife und iceDealerData[group][hier mit for schleife durch gehen] und dann die einzelnen types mit if abfrage abfragen 
                ...
                for (let i = 0; i < EisDealerFreude22.iceDealerData[group].length; i++) {
                    if (EisDealerFreude22.iceDealerData[group][i].type == "options") {
                        console.log("Eissorte " + EisDealerFreude22.iceDealerData[group][i].name + " wird geladen");
                        if (EisDealerFreude22.iceDealerData[group][i].inStock == true) {
                            if (EisDealerFreude22.iceDealerData[group][i].value == "Langweilige Eissorten") {
                                let a = 1;
                                while (a <= 4) {
                                    writeHTMLIceFlavor(EisDealerFreude22.iceDealerData[group][i], "IceOptionsOne" + a);
                                    a++;
                                }
                            }
                            else if (EisDealerFreude22.iceDealerData[group][i].value == "Moderne Eissorten") {
                                let a = 1;
                                while (a <= 4) {
                                    writeHTMLIceFlavor(EisDealerFreude22.iceDealerData[group][i], "IceOptionsTwo" + a);
                                    a++;
                                }
                            }
                        }
                ...
                for (let i = 0; i < EisDealerFreude22.iceDealerData[group].length; i++) {
                    if (EisDealerFreude22.iceDealerData[group][i].inStock == true) {
                        writeHTML(EisDealerFreude22.iceDealerData[group][i], group, "Lable" + lableNum);
...
})(EisDealerFreude22 || (EisDealerFreude22 = {}));
