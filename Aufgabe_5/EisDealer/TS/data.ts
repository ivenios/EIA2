namespace EisDealerFreude {
    ...
    export let iceDealerData: {[group: string]: fieldsetData[]}
		...
		"Streußel": [
            {name:"Schoko-Steußel", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Snickers", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Tropical", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Schokolinsen", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Lions-Steußel", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Bounty-Steußel", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Kit-Kat-Steußel", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"Buchstabenstreußel", type:"checkbox", value:"" , price: 0.80, inStock: true},
            {name:"HFU-Steußel", type:"checkbox", value:"" , price: 0.80, inStock: true}
        ],
        "Saucen": [
            {name:"Schoko-Sauce", type:"checkbox", value:"" , price: 0.8, inStock: true},
            {name:"Karamell-Sauce", type:"checkbox", value:"" , price: 0.8, inStock: true},
            {name:"Vanille-Sauce", type:"checkbox", value:"" , price: 0.8, inStock: true},
            {name:"Himbeere-Sauce", type:"checkbox", value:"" , price: 0.8, inStock: true},
